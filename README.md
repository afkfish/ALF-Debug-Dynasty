...
Csapatnév: Debug Dynasty

Csapattagok Neptun kóddal:
- Kis Benedek M. (JOYAXJ)
- Sőregi Larina (M4B9MC)
- Nyilas Péter (Y8QBCS)
- Farkas Bence (D6AE9F)

Bemutató videó URL: [link](https://youtu.be/zjwOkaR9rag)
...
- [X] 7p: Yocto projekt alapokon készített szerver vagy kliens (házi feladatonként egyszer)
